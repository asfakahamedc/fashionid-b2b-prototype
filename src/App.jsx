      ...
      <main>
        ...
        <section className="relative pt-24 pb-32 sm:pt-32 sm:pb-40 overflow-hidden bg-stone-50" id="hero-section" data-testid="hero-section">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 
              className="text-5xl sm:text-6xl md:text-7xl font-black tracking-tighter text-stone-950 mb-8 leading-tight"
              id="hero-h1"
              data-testid="hero-h1"
            >
        ...
        <section className="py-24 bg-stone-50 border-b border-stone-900" id="pain-solution-section" data-testid="pain-solution-section">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-16 text-center">
              <h2 className="text-4xl font-black mb-4 text-stone-950 tracking-tight" id="matrix-h2" data-testid="matrix-h2">Why Switch to FashionID?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="p-8 bg-white border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] relative overflow-hidden group hover:-translate-y-1 hover:shadow-[10px_10px_0px_0px_rgba(28,25,23,1)] transition-all">
                ...
                <div className="mb-6">
                  ...
                  <h3 className="text-xl font-black text-stone-950 mt-1 leading-tight">Language Barriers & Delays</h3>
                </div>
              ...
              <div className="p-8 bg-white border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] relative overflow-hidden group hover:-translate-y-1 hover:shadow-[10px_10px_0px_0px_rgba(28,25,23,1)] transition-all">
                ...
                <div className="mb-6">
                  <span className="text-xs font-black tracking-widest text-stone-500 uppercase">The Pain</span>
                  <h3 className="text-xl font-black text-stone-950 mt-1 leading-tight">Inconsistent Quality</h3>
                </div>
                <div className="pt-6 border-t border-stone-200">
                  <span className="text-xs font-black tracking-widest text-yellow-500 uppercase drop-shadow-[1px_1px_0px_rgba(28,25,23,1)]">Our Solution</span>
                  <p className="text-stone-700 font-medium mt-3 text-sm leading-relaxed">
              ...
              <div className="p-8 bg-white border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] relative overflow-hidden group hover:-translate-y-1 hover:shadow-[10px_10px_0px_0px_rgba(28,25,23,1)] transition-all">
                ...
                <div className="mb-6">
                  <span className="text-xs font-black tracking-widest text-stone-500 uppercase">The Pain</span>
                  <h3 className="text-xl font-black text-stone-950 mt-1 leading-tight">Missed Deadlines</h3>
                </div>
                <div className="pt-6 border-t border-stone-200">
                  <span className="text-xs font-black tracking-widest text-yellow-500 uppercase drop-shadow-[1px_1px_0px_rgba(28,25,23,1)]">Our Solution</span>
                  <p className="text-stone-700 font-medium mt-3 text-sm leading-relaxed">
        ...
        <section className="py-24 bg-stone-100 border-b border-stone-900" id="competencies-section" data-testid="competencies-section">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-16">
              <h2 className="text-4xl font-black mb-4 text-stone-950 tracking-tight" id="competencies-h2" data-testid="competencies-h2">Capabilities & Services.</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="p-8 bg-white border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] hover:shadow-[10px_10px_0px_0px_rgba(28,25,23,1)] hover:-translate-y-1 transition-all" id="comp-card-sourcing" data-testid="comp-card-sourcing">
                ...
                <h3 className="text-xl font-black text-stone-950 mb-4 tracking-tight">Strategic Sourcing</h3>
              ...
              <div className="p-8 bg-white border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] hover:shadow-[10px_10px_0px_0px_rgba(28,25,23,1)] hover:-translate-y-1 transition-all" id="comp-card-manufacturing" data-testid="comp-card-manufacturing">
                ...
                <h3 className="text-xl font-black text-stone-950 mb-4 tracking-tight">Contract Mfg</h3>
                <ul className="space-y-3">
              ...
              <div className="p-8 bg-white border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] hover:shadow-[10px_10px_0px_0px_rgba(28,25,23,1)] hover:-translate-y-1 transition-all" id="comp-card-qc" data-testid="comp-card-qc">
                ...
                <h3 className="text-xl font-black text-stone-950 mb-4 tracking-tight">Quality Control</h3>
                <ul className="space-y-3">
              ...
              <div className="p-8 bg-white border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] hover:shadow-[10px_10px_0px_0px_rgba(28,25,23,1)] hover:-translate-y-1 transition-all" id="comp-card-logistics" data-testid="comp-card-logistics">
                ...
                <h3 className="text-xl font-black text-stone-950 mb-4 tracking-tight">Global Logistics</h3>
                <ul className="space-y-3">
        ...
        <section className="py-24 bg-stone-50 border-b border-stone-900" id="showcase-section" data-testid="showcase-section">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-16">
              <h2 className="text-4xl font-black mb-4 text-stone-950 tracking-tight" id="showcase-h2" data-testid="showcase-h2">Production Capabilities.</h2>
              <div className="w-20 h-2 bg-yellow-400 rounded-sm"></div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="group relative h-72 rounded-sm border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] overflow-hidden cursor-pointer duration-300">
                ...
                <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col justify-end translate-y-12 group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="text-xl font-black text-white group-hover:text-stone-950 tracking-wider mb-2 drop-shadow-md group-hover:drop-shadow-none transition-colors">1. Denims (Pants & Jackets)</h3>
              ...
              <div className="group relative h-72 rounded-sm border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] overflow-hidden cursor-pointer duration-300">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-stone-950/90 via-stone-950/20 to-transparent group-hover:bg-yellow-400/95 transition-all duration-300"></div>
                <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col justify-end translate-y-12 group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="text-xl font-black text-white group-hover:text-stone-950 tracking-wider mb-2 drop-shadow-md group-hover:drop-shadow-none transition-colors">2. Shirts (Casual & Formal)</h3>
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
              ...
              <div className="group relative h-72 rounded-sm border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] overflow-hidden cursor-pointer duration-300">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-stone-950/90 via-stone-950/20 to-transparent group-hover:bg-yellow-400/95 transition-all duration-300"></div>
                <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col justify-end translate-y-12 group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="text-xl font-black text-white group-hover:text-stone-950 tracking-wider mb-2 drop-shadow-md group-hover:drop-shadow-none transition-colors">3. T-shirts</h3>
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
              ...
              <div className="group relative h-72 rounded-sm border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] overflow-hidden cursor-pointer duration-300">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-stone-950/90 via-stone-950/20 to-transparent group-hover:bg-yellow-400/95 transition-all duration-300"></div>
                <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col justify-end translate-y-12 group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="text-xl font-black text-white group-hover:text-stone-950 tracking-wider mb-2 drop-shadow-md group-hover:drop-shadow-none transition-colors">4. Polos</h3>
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
              ...
              <div className="group relative h-72 rounded-sm border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] overflow-hidden cursor-pointer duration-300">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-stone-950/90 via-stone-950/20 to-transparent group-hover:bg-yellow-400/95 transition-all duration-300"></div>
                <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col justify-end translate-y-12 group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="text-xl font-black text-white group-hover:text-stone-950 tracking-wider mb-2 drop-shadow-md group-hover:drop-shadow-none transition-colors">5. Jackets (Winter & Fashion)</h3>
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
              ...
              <div className="group relative h-72 rounded-sm border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] overflow-hidden cursor-pointer duration-300">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-stone-950/90 via-stone-950/20 to-transparent group-hover:bg-yellow-400/95 transition-all duration-300"></div>
                <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col justify-end translate-y-12 group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="text-xl font-black text-white group-hover:text-stone-950 tracking-wider mb-2 drop-shadow-md group-hover:drop-shadow-none transition-colors">6. Lingeries</h3>
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
              ...
              <div className="group relative h-72 rounded-sm border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] overflow-hidden cursor-pointer duration-300">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-stone-950/90 via-stone-950/20 to-transparent group-hover:bg-yellow-400/95 transition-all duration-300"></div>
                <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col justify-end translate-y-12 group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="text-xl font-black text-white group-hover:text-stone-950 tracking-wider mb-2 drop-shadow-md group-hover:drop-shadow-none transition-colors">7. Uniform (Corporate & Ind.)</h3>
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
              ...
              <div className="group relative h-72 rounded-sm border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] overflow-hidden cursor-pointer duration-300">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-stone-950/90 via-stone-950/20 to-transparent group-hover:bg-yellow-400/95 transition-all duration-300"></div>
                <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col justify-end translate-y-12 group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="text-xl font-black text-white group-hover:text-stone-950 tracking-wider mb-2 drop-shadow-md group-hover:drop-shadow-none transition-colors">8. Cotton Pants</h3>
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
              ...
              <div className="group relative h-72 rounded-sm border-2 border-stone-950 shadow-[6px_6px_0px_0px_rgba(28,25,23,1)] overflow-hidden cursor-pointer duration-300">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-stone-950/90 via-stone-950/20 to-transparent group-hover:bg-yellow-400/95 transition-all duration-300"></div>
                <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col justify-end translate-y-12 group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="text-xl font-black text-white group-hover:text-stone-950 tracking-wider mb-2 drop-shadow-md group-hover:drop-shadow-none transition-colors">9. Cargo/Sweat Pants</h3>
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
        ...
        <section className="py-24 bg-stone-50 border-y border-stone-900" id="compliance-section" data-testid="compliance-section">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl font-black mb-4 text-stone-950 tracking-tight" id="compliance-h2" data-testid="compliance-h2">Global Compliance Standards.</h2>
              ...
              <div className="relative">
                <div className="aspect-square rounded-full bg-white border-[6px] border-stone-950 shadow-[10px_10px_0px_0px_rgba(28,25,23,1)] overflow-hidden flex items-center justify-center p-12">
                   <div className="text-center">
                     ...
                     <h3 className="text-3xl font-black text-stone-950 tracking-widest leading-tight">100%<br/>VERIFIED</h3>
        ...
        <section className="py-24 bg-stone-50 border-b border-stone-900" id="leadership-section" data-testid="leadership-section">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-16">
              <h2 className="text-4xl font-black mb-4 text-stone-950 tracking-tight" id="leadership-h2" data-testid="leadership-h2">The Team Behind the Trade.</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              ...
              <div className="text-center group" id="leader-arif" data-testid="leader-arif">
                ...
                <h3 className="text-2xl font-black text-stone-950">Arif Akram</h3>
              ...
              <div className="text-center group" id="leader-adnan" data-testid="leader-adnan">
                ...
                <h3 className="text-2xl font-black text-stone-950">Adnan Akram</h3>
               ...
               <div className="text-center group" id="leader-azam" data-testid="leader-azam">
                ...
                <h3 className="text-2xl font-black text-stone-950">Azam Akram</h3>
